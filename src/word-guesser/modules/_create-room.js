...
var CreateRoom = function (props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: 'h3', children: "Create a room" }), (0, jsx_runtime_1.jsx)(material_1.List, { children: (0, jsx_runtime_1.jsxs)(material_1.ListItem, { sx: { gap: '1rem', paddingLeft: 0 }, children: [(0, jsx_runtime_1.jsx)(material_1.TextField, { error: errMsg ? true : false, fullWidth: true, label: "Room Name", value: newRoomName, onChange: function (e) { return setNewRoomName(e.target.value); }, InputProps: { endAdornment: (0, jsx_runtime_1.jsx)(material_1.Tooltip, { title: !props.roomPrivate ? 'Sets the room to public so anyone can join' : 'Sets the room to private so it does not appear in the room list', children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { onClick: function () { return props.setRoomPrivate(!props.roomPrivate); }, children: !props.roomPrivate ? (0, jsx_runtime_1.jsx)(icons_material_1.Visibility, { color: 'primary' }) : (0, jsx_runtime_1.jsx)(icons_material_1.VisibilityOff, {}) }) })
                            }, onKeyUp: function (e) { if (e.key === "Enter") {
                                CheckRoom(newRoomName);
                            } } }), (0, jsx_runtime_1.jsx)(material_1.Button, { className: 'btn__input', variant: 'contained', onClick: function () { return CheckRoom(newRoomName); }, children: "Create" })] }) }), (0, jsx_runtime_1.jsx)(material_1.Typography, { minHeight: '1.5rem', color: 'red', children: errMsg })] }));
};

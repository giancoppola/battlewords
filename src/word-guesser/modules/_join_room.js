...
var _room_list_dialog_1 = require("./_room_list_dialog");
var JoinRoom = function (props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: 'h3', children: "Join a room" }), (0, jsx_runtime_1.jsxs)(material_1.List, { children: [(0, jsx_runtime_1.jsxs)(material_1.ListItem, { sx: { gap: '1rem', paddingLeft: 0 }, children: [(0, jsx_runtime_1.jsx)(material_1.TextField, { error: errMsg ? true : false, fullWidth: true, label: "Room Name", value: newRoomName, onChange: function (e) { return setNewRoomName(e.target.value); }, onKeyUp: function (e) { if (e.key === "Enter") {
                                            CheckRoom(newRoomName);
                                        } } }), (0, jsx_runtime_1.jsx)(material_1.Button, { className: 'btn__input', variant: 'contained', onClick: function () { return CheckRoom(newRoomName); }, children: "Join" })] }), (0, jsx_runtime_1.jsx)(material_1.ListItem, { sx: { paddingLeft: 0 }, children: (0, jsx_runtime_1.jsx)(material_1.Button, { fullWidth: true, variant: 'outlined', onClick: function () { return setShowRoomList(true); }, children: "Find a Public Room" }) })] }), (0, jsx_runtime_1.jsx)(material_1.Typography, { minHeight: '1.5rem', color: 'red', children: errMsg })] }), (0, jsx_runtime_1.jsx)(_room_list_dialog_1.RoomListDialog, { CheckRoom: CheckRoom, open: showRoomList, setOpen: setShowRoomList })] }));
};
